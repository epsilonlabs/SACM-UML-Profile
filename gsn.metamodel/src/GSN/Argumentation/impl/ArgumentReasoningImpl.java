 ...
 * </p>
 * <ul>
 *   <li>{@link GSN.Argumentation.impl.ArgumentReasoningImpl#getStructure <em>Structure</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ArgumentReasoningImpl extends ArgumentAssetImpl implements ArgumentReasoning {
	/**
		...
		if (structure != null && structure.eIsProxy()) {
			...
			if (structure != oldStructure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArgumentationPackage.ARGUMENT_REASONING__STRUCTURE, oldStructure, structure));
			}
		}
		return structure;
	}
	...
	public void setStructure(ArgumentPackage newStructure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArgumentationPackage.ARGUMENT_REASONING__STRUCTURE, oldStructure, structure));
	}
