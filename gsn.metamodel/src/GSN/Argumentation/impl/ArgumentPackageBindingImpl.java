 ...
 * </p>
 * <ul>
 *   <li>{@link GSN.Argumentation.impl.ArgumentPackageBindingImpl#getParticipantPackage <em>Participant Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ArgumentPackageBindingImpl extends ArgumentPackageImpl implements ArgumentPackageBinding {
	/**
	...
	protected EClass eStaticClass() {
		return ArgumentationPackage.Literals.ARGUMENT_PACKAGE_BINDING;
	}
	...
	public EList<ArgumentPackage> getParticipantPackage() {
		if (participantPackage == null) {
			participantPackage = new EObjectResolvingEList<ArgumentPackage>(ArgumentPackage.class, this, ArgumentationPackage.ARGUMENT_PACKAGE_BINDING__PARTICIPANT_PACKAGE);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArgumentationPackage.ARGUMENT_PACKAGE_BINDING__PARTICIPANT_PACKAGE:
